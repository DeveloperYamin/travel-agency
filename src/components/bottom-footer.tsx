            ...
            <div className="col-lg-3 col-md-4">
              <div className="footer-widget">
                ...
                <div className="footer-add pe-xl-3">
                  <p>
                    We make your dream more beautiful &amp; enjoyful with lots
                    of happiness.
                  </p>
                </div>
            ...
            <div className="col-lg-2 col-md-4">
              <div className="footer-widget">
                ...
                <ul className="footer-menu">
                  ...
                  <li>
                    <a href="JavaScript:Void(0);">Payroll Services</a>
                  </li>
                  <li>
                    <a href="JavaScript:Void(0);">Direct Contracts</a>
                  </li>
                  <li>
                    <a href="JavaScript:Void(0);">Hire Worldwide</a>
                  </li>
                  <li>
                    <a href="JavaScript:Void(0);">Hire in the USA</a>
                  </li>
                  <li>
                    <a href="JavaScript:Void(0);">How to Hire</a>
                  </li>
                </ul>
              </div>
            </div>
            <div className="col-lg-2 col-md-4">
              <div className="footer-widget">
                ...
                <ul className="footer-menu">
                  ...
                  <li>
                    <a href="JavaScript:Void(0);">Upwork Reviews</a>
                  </li>
                  <li>
              ...
              <div className="footer-widget">
                ...
                <div className="our-prtwrap mt-4">
                  <div className="prtn-title">
                    <p className="text-light opacity-75 fw-medium">
                      Our Partners
                    </p>
                  </div>
